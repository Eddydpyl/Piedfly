...
public class UserHolderItemTouchHelper extends ItemTouchHelper.SimpleCallback {
    ...
    public UserHolderItemTouchHelper(int dragDirs, int swipeDirs, RecyclerItemTouchHelperListener mListener) {
    ...
    public void onSelectedChanged(RecyclerView.ViewHolder viewHolder, int actionState) {
        if (viewHolder != null) {
            final View foregroundView = ((UserHolder) viewHolder).mViewForeground;
