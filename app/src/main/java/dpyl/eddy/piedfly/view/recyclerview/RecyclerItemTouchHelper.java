...
public class RecyclerItemTouchHelper extends ItemTouchHelper.SimpleCallback {
    ...
    public RecyclerItemTouchHelper(int dragDirs, int swipeDirs, RecyclerItemTouchHelperListener mListener) {
    ...
    public void onSelectedChanged(RecyclerView.ViewHolder viewHolder, int actionState) {
        if (viewHolder != null) {
            final View foregroundView = ((UserAdapter.UserHolder) viewHolder).mViewForeground;
